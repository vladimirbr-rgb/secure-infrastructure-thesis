...
> Ссылки на обезличенные отчёты, чек-лист аудита, корпоративные стандарты и журналы автоматизированных проверок будут добавлены после загрузки файлов в репозиторий.
